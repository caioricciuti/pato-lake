...
// Handles both double-quoted and unquoted identifiers.
...
func ExtractLineage(entry QueryLogEntry) []LineageEdge {
...
// isSystemTable returns true for system and information_schema
