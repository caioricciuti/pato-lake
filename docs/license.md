...
Patolake uses a dual-license model: open source core + commercial Pro modules.

---

## Patolake Core (Community Edition)

**License:** [Apache License 2.0](../LICENSE)

The core of Patolake is free and open source. This includes:
...
You can use, modify, and distribute Patolake Core freely under the Apache 2.0 license.

## Patolake Pro

**License:** Commercial (proprietary)

Pro modules extend Patolake with advanced features:
...
1. Open Patolake in your browser
...
Visit [patolake.com/pricing](https://patolake.com/pricing) or contact **c.ricciuti@patolake.com**.
...
**Can I use Patolake Core in production?**
Yes, freely. Apache 2.0 allows commercial use.

**Can I modify Patolake Core?**
Yes. You must retain the copyright notice and license.

**Do I need Pro for a single DuckDB connection?**
