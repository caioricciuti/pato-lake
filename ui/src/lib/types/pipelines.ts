...
export const SINK_NODE_TYPES: { type: NodeType; label: string; description: string }[] = [
  { type: 'sink_duckdb', label: 'DuckDB', description: 'Insert into DuckDB table' },
]
...
export const CONNECTOR_FIELDS: Record<NodeType, ConnectorFieldDef[]> = {
  source_kafka: [
    ...
    { key: 'consumer_group', label: 'Consumer Group', type: 'text', required: true, default: 'patolake-pipeline' },
    ...
    { key: 'batch_size', label: 'Batch Size', type: 'number', default: 1000, help: 'Records per batch before flushing to DuckDB' },
  ...
  sink_duckdb: [
    { key: 'schema', label: 'Target Schema', type: 'text', required: true, default: 'main', help: 'DuckDB schema to write into' },
