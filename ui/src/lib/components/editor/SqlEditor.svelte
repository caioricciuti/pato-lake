<script lang="ts">
  ...
  import { duckdbCompletionSource } from '../../editor/completions'
  ...
  let { value = '', onrun, onchange, onsave }: Props = $props()
  ...
  const lightTheme = EditorView.theme({
    ...
    '.cm-selectionBackground': { backgroundColor: '#fef08a !important' },
    '&.cm-focused .cm-selectionBackground': { backgroundColor: '#fde047 !important' },
    '.cm-cursor': { borderLeftColor: '#1f2126' },
    '.cm-matchingBracket': { backgroundColor: '#fef9c3', outline: '1px solid #eab308' },
  ...
  const darkTheme = EditorView.theme({
    ...
    '.cm-activeLine': { backgroundColor: 'rgba(234,179,8,0.12)' },
    '.cm-activeLineGutter': { backgroundColor: 'rgba(234,179,8,0.18)' },
    '.cm-selectionBackground': { backgroundColor: 'rgba(250,204,21,0.32) !important' },
    '.cm-matchingBracket': { backgroundColor: 'rgba(234,179,8,0.22)', outline: '1px solid rgba(250,204,21,0.9)' },
    '.cm-panels': { backgroundColor: '#18191f', color: '#fef08a' },
  ...
  onMount(() => {
    const state = EditorState.create({
      ...
      extensions: [
        ...
        autocompletion({
          override: [duckdbCompletionSource],
