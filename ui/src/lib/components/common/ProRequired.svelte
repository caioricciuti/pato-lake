...
<div class="h-full overflow-auto p-6">
  <div class="mx-auto max-w-2xl">
    <div class="ds-panel overflow-hidden">
      <!-- Header -->
      <div class="px-6 py-5 border-b border-yellow-300/25 dark:border-yellow-700/35 bg-gradient-to-r from-yellow-100/60 via-transparent to-transparent dark:from-yellow-500/10">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div class="flex items-center gap-4 min-w-0">
            <div class="h-14 w-14 rounded-2xl border border-yellow-300/40 dark:border-yellow-700/40 bg-gray-100 dark:bg-gray-900 grid place-items-center overflow-hidden shrink-0">
              <img src={logo} alt="Patolake logo" class="h-11 w-11 object-contain" />
            </div>
            <div>
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">
                <span class="text-ch-orange font-medium">{feature}</span> is part of Patolake Pro.
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="p-6 space-y-6">
        ...
        <div class="flex items-center gap-3 rounded-lg border border-yellow-300/30 dark:border-yellow-700/30 bg-yellow-50/50 dark:bg-yellow-900/10 px-4 py-3">
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-3 pt-2 border-t border-gray-200 dark:border-gray-800">
          ...
          <a
            ...
            href="https://patolake.com/pricing"
            target="_blank"
            rel="noreferrer"
          >
