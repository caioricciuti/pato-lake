...
<div class="rounded-lg border-2 {statusColor} {statusBg} shadow-sm min-w-[180px] cursor-pointer hover:shadow-md transition-shadow">
  ...
  <Handle type="target" position={Position.Left} class="!bg-yellow-500 !w-3 !h-3 !border-2 !border-white dark:!border-gray-900" />
  <Handle type="source" position={Position.Right} class="!bg-yellow-500 !w-3 !h-3 !border-2 !border-white dark:!border-gray-900" />
</div>
