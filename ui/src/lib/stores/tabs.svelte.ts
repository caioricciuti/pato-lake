...
export type TabType = 'home' | 'query' | 'table' | 'database' | 'dashboard' | 'model' | 'saved-queries' | 'settings' | 'dashboards' | 'schedules' | 'brain' | 'admin' | 'governance' | 'pipelines' | 'models' | 'ingest' | 'notebooks'
...
export interface SingletonTab extends TabBase {
  type: 'saved-queries' | 'settings' | 'dashboards' | 'schedules' | 'brain' | 'admin' | 'governance' | 'pipelines' | 'models' | 'ingest' | 'notebooks'
}
...
const STORAGE_KEY = 'patolake-tabs'
