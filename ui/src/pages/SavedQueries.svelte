    ...
    <div class="mx-auto max-w-6xl space-y-4">
      ...
      {#if loading}
        <div class="grid grid-cols-1 gap-3">
          {#each { length: 4 } as _}
            <div class="ds-panel rounded-xl px-4 py-3 space-y-3">
              <div class="flex items-center gap-2">
                <Skeleton width="180px" height="1rem" rounded="rounded" />
                <Skeleton width="50px" height="1.2rem" rounded="rounded-md" />
              </div>
              <Skeleton height="3.5rem" rounded="rounded-md" />
              <div class="flex items-center gap-3">
                <Skeleton width="80px" height="0.75rem" rounded="rounded" />
                <Skeleton width="60px" height="0.75rem" rounded="rounded" />
              </div>
            </div>
          {/each}
        </div>
      ...
      {:else}
        <div class="grid grid-cols-1 gap-3">
          {#each visibleQueries as query (query.id)}
            <article
              class="ds-panel rounded-xl transition-colors hover:border-yellow-400/45"
