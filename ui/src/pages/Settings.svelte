...
<div class="h-full overflow-auto">
  <div class="max-w-7xl mx-auto p-6 space-y-4">
    <section class="ds-panel overflow-hidden">
      <div class="px-5 py-4 border-b border-yellow-300/25 dark:border-yellow-700/35 bg-gradient-to-r from-yellow-100/60 via-transparent to-transparent dark:from-yellow-500/10 dark:via-transparent">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div class="flex items-center gap-4 min-w-0">
            <div class="h-16 w-16 rounded-2xl border border-yellow-300/40 dark:border-yellow-700/40 bg-gray-100 dark:bg-gray-900 grid place-items-center overflow-hidden shrink-0">
              <img src={logo} alt="Patolake logo" class="h-12 w-12 object-contain" />
            </div>
            <div class="min-w-0">
              <div class="flex items-center gap-2 text-gray-900 dark:text-gray-100">
                <SettingsIcon size={18} class="text-ch-orange" />
                <h1 class="text-2xl font-semibold leading-tight">Patolake License</h1>
              </div>
      ...
      <aside class="space-y-4">
        ...
        <section class="ds-panel p-5">
          ...
          <div class="flex items-center gap-3">
            <img src={logo} alt="Patolake mark" class="h-12 w-12 rounded-xl border border-yellow-300/35 dark:border-yellow-700/35 bg-gray-100 dark:bg-gray-900 p-1.5" />
            <div>
              <p class="text-sm font-semibold text-gray-900 dark:text-gray-100">Patolake</p>
              <p class="text-xs text-gray-500 dark:text-gray-400">DuckDB operations and analytics control surface</p>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-2 mt-3">
            <div class="ds-panel-muted p-2.5">
              ...
              <p class="text-xs font-medium text-gray-800 dark:text-gray-200 mt-1">{session?.user?.username || '—'}</p>
            </div>
            <div class="ds-panel-muted p-2.5">
              <p class="text-[11px] uppercase tracking-wide text-gray-500 dark:text-gray-400">Role</p>
              <p class="text-xs font-medium text-gray-800 dark:text-gray-200 mt-1 uppercase">{session?.user?.role || '—'}</p>
            </div>
            <div class="ds-panel-muted p-2.5">
              <p class="text-[11px] uppercase tracking-wide text-gray-500 dark:text-gray-400">Database</p>
              <p class="text-xs font-medium text-gray-800 dark:text-gray-200 mt-1">DuckDB (local)</p>
            </div>
            <div class="ds-panel-muted p-2.5">
        ...
        <section class="ds-panel p-5">
          ...
          <div class="mt-3 flex items-center gap-2 flex-wrap">
            ...
            <a
              href="https://github.com/caioricciuti/pato-lake/blob/main/docs/license.md"
              target="_blank"
              rel="noreferrer"
              class="ds-btn-outline px-3 py-1"
            >
              <KeyRound size={12} /> Patolake License Policy <ExternalLink size={12} />
            </a>
            <a
              href="https://github.com/caioricciuti/pato-lake/blob/main/docs/legal/terms-of-service.md"
              target="_blank"
              rel="noreferrer"
              class="ds-btn-outline px-3 py-1"
            >
            ...
            <a
              href="https://github.com/caioricciuti/pato-lake/blob/main/docs/legal/privacy-policy.md"
              target="_blank"
              rel="noreferrer"
              class="ds-btn-outline px-3 py-1"
            >
